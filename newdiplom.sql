...
-- Дамп данных таблицы newdiplom.dishes_in_order: ~1 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.dishs: ~5 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.dish_types: ~10 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.ingredients: ~15 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.ingredients_in_dish: ~26 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.orders: ~1 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.users: ~11 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.user_orders: ~1 rows (приблизительно)
