...
DROP DATABASE IF EXISTS `newdiplom`;
...
-- Дамп данных таблицы newdiplom.dishes_in_order: ~50 rows (приблизительно)
...
-- Дамп данных таблицы newdiplom.orders: ~40 rows (приблизительно)
...
DROP TABLE IF EXISTS `order_pay_types`;
...
-- Дамп данных таблицы newdiplom.order_pay_types: ~3 rows (приблизительно)
...
DROP TABLE IF EXISTS `users_accesses`;
